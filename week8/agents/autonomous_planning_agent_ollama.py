...
from agents.ensemble_agent_Ollama import EnsembleAgent
from agents.messaging_agent_ollama import MessagingAgent
    ...
    def plan(self, memory: List[str] = []) -> Optional[Opportunity]:
        ...
        while not done:
            response = self.groq.chat.completions.create(
                model=self.MODEL, messages=messages, reasoning_effort= None, tools=self.get_tools()
            )
